  ...
  return (
    <>
      <header ref={headerRef} id="site-header" className="fixed top-0 left-0 right-0 z-50 transition-all duration-300">
        <div className="page-container flex items-center justify-between h-16">
          ...
          <nav className="hidden lg:flex items-center gap-1 flex-1 justify-end">
            ...
            <a href="https://github.com/your-repo/automl" target="_blank" rel="noopener" className="link-dimmed text-[13px] px-3 py-1.5 rounded-md flex items-center gap-1">
          ...
          <div className="hidden lg:flex items-center gap-3 ml-6">
            <a href="#get-started" className="btn btn-primary text-[13px] h-8 px-3 rounded-md">Get Started</a>
          </div>
      ...
      <div className={`mobile-menu${menuOpen ? ' open' : ''}`}>
        ...
        <a href="https://github.com/your-repo/automl" target="_blank" rel="noopener" onClick={closeMenu}>GitHub</a>
        <div className="px-[var(--page-outer-padding)] pt-6 flex flex-col gap-3">
          <a href="#get-started" className="btn btn-primary" onClick={closeMenu}>Get Started</a>
        </div>
      </div>
    </>
  );
